    ...
    <div className="landing">
      <section className="landing__hero">
        ...
        <div className="hero-content">
          <h1 className="hero-title">SHORT ON DINNER-TIME INSPIRATION?</h1>
        ...
        <div className="landing__features-content">
          ...
          <div className="feature">
            ...
            <div className="feature__content">
              ...
              <p>
                Month-to-month, discover recipes that use only fresh, local
                ingredients.
              </p>
            </div>
          </div>
          ...
          <div className="feature">
            ...
            <div className="feature__content">
              ...
              <p>
                Create a profile and save your favourite seasonal recipes to
                come back to.
              </p>
            </div>
          </div>
          ...
          <div className="feature">
            ...
            <div className="feature__content">
              ...
              <p>
                Filter recipes by ease, nutritional value, time-taken and type
                of cuisine.
              </p>
            </div>
          </div>
