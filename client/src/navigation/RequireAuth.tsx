...
export function RequireAuth () {
  ...
  if (authStatus === 'error') return <StatusPanel mode="error" message={authError ?? "Can't reach server."} />

  if (showLoading) return <StatusPanel mode="loading" message="Authenticating user..."/>
