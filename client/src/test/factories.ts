...
export function makeUser(overrides: Partial<UserAuthResponseT> = {}): UserAuthResponseT {
  return {
...
export function makeRecipeCard(overrides: Partial<RecipeCardT> = {}): RecipeCardT {
  return {
    _id: "irish_pork_1",
...
export function makeAdditionalRecipeCard(overrides: Partial<RecipeCardT> = {}): RecipeCardT {
  return {
...
export function makeRecipe(overrides: Partial<RecipeT> = {}): RecipeT {
  return {
    _id: "irish_pork_1",
    name: "Irish coddled pork with cider",
    description: "Host your own St Patrick’s day party with this cider infused Irish stew, perfect with a side of colcannon and a pint of Guinness",
    image: [
      {
        url: "https://images.immediate.co.uk/production/volatile/sites/30/2020/08/recipe-image-legacy-id-9116_11-41d76aa.jpg?resize=440,400",
        width: 440,
    ...
    keywords: "800 kcal or less, Alcohol, Ireland, Irish, Mains, St Patrick's day, Stew",
    prepTime: "PT35M",
    cookTime: "PT1H5M",
    totalTime: "PT2H10M",
    skillLevel: "Easy",
