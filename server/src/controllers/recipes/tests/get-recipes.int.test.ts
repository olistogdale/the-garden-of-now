...
describe('POST /recipes', () => {
  ...
  it('throws an error for invalid seed input (400)', async () => {
    ...
    await expectError(
      app,
      { ingredients: mockIngredients, seed: 1 },
      400,
      seedErrorReturned,
    );
    await expectError(
      app,
      { ingredients: mockIngredients, seed: '   ' },
      400,
      seedErrorReturned,
    );
    await expectError(
      app,
      { ingredients: mockIngredients, seed: 'a'.repeat(129) },
      400,
      seedErrorReturned,
    );
  });
  ...
  it('throws an error for invalid ingredients input (400)', async () => {
    ...
    const ingredientsErrorReturned =
    ...
    await expectError(
      app,
      { ingredients: 1, seed: mockSeed },
      400,
      ingredientsErrorReturned,
    );
    await expectError(
      app,
      { ingredients: [], seed: mockSeed },
      400,
      ingredientsErrorReturned,
    );
  });
